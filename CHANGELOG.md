...
[improvement] Extensions button, badge

- improvement color contrast and readability (Blue Whale & H@cker)

## 5.0.0

### What's Changed

* Improve contrast ration between backgrounds & syntax colors for all Dark themes by @stoneC0der in [pull request](https://github.com/stoneC0der/g-dark-theme/pull/25)

**Full Changelog**: [Changelog](https://github.com/stoneC0der/g-dark-theme/compare/4.5.0...4.6.0)
